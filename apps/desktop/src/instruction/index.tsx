...
export function InstructionScreen({
  ...
  if (type === "billing") {
    return (
      <ExternalInstruction
        ...
        description={t`Finish checkout in your browser, then return to Notare.`}
  ...
  return (
    <ExternalInstruction
      ...
      description={t`Authorize access in your browser, then return to Notare.`}
...
function SignInInstruction({ onBack }: { onBack: () => void }) {
  ...
  return (
    <InstructionShell
      ...
      description={t`Complete sign-in in your browser, then return to Notare.`}
      onBack={onBack}
    >
      {showCallbackInput ? (
        <>
          <div className="flex w-full flex-col gap-2">
            <Input
              ...
              placeholder="notare://deeplink/auth?access_token=..."
              value={callbackUrl}
