...
export function ChatCTA({
  ...
  return (
    <button
      ...
      aria-label={ariaLabel ?? t`Ask Notare anything`}
      onClick={handleClick}
    ...
    >
      <span
        ...
        className={cn([
          ...
          "origin-bottom bg-[linear-gradient(180deg,#f7f8fa_0%,#e1e3e9_100%)] px-0 text-sm shadow-[0_0_0_1px_rgba(0,0,0,0.1),0_4px_12px_rgba(0,0,0,0.16),0_4px_16px_rgba(0,0,0,0.1),inset_0_-1px_0_rgba(0,0,0,0.25),inset_0_1px_0_rgba(255,255,255,0.4)] transition-[clip-path,height,padding,background-color,border-color,box-shadow] duration-200 ease-out dark:bg-[linear-gradient(180deg,#191d28_0%,#3b4460_100%)] dark:shadow-[0_4px_12px_rgba(11,13,18,0.1),inset_0_-1px_0_rgba(0,0,0,0.25),inset_0_1px_0_rgba(255,255,255,0.4)]",
          "group-hover/anarlog-chat-cta:border-border/70 group-focus-visible/anarlog-chat-cta:border-border/70 group-hover/anarlog-chat-cta:bg-[#eef0f4] group-focus-visible/anarlog-chat-cta:bg-[#eef0f4] dark:group-hover/anarlog-chat-cta:bg-[#1a1e29] dark:group-focus-visible/anarlog-chat-cta:bg-[#1a1e29]",
