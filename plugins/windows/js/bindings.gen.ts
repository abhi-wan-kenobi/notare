...
export const events = __makeEvents__<{
  ...
  floatingBarReady: FloatingBarReady;
  floatingBarSettingsChange: FloatingBarSettingsChange;
  floatingBarStateEvent: FloatingBarStateEvent;
  ...
  floatingBarReady: "plugin:windows:floating-bar-ready",
  floatingBarSettingsChange: "plugin:windows:floating-bar-settings-change",
  floatingBarStateEvent: "plugin:windows:floating-bar-state-event",
 ...
 */
export type FloatingBarReady = Record<string, never>;
 ...
 */
export type FloatingBarStateEvent = { state: FloatingBarState };
